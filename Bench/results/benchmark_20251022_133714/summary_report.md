...
| 电路名称 | 量子比特数 | 电路深度 | 门总数 |
|---------|-----------|---------|--------|
| grover_21_qubits | 21 | 6824.0 | 97804.0 |

### 电路摘要示例

```
Circuit depth = 6824
Total number of gates = 97804
Number of qubits = 21
Most common gates:
h: 47775
x: 47754
...
- 电路: grover_21_qubits (21 qubits)
- 平均时间: 117.2155 ± 4.1236 秒
...
n_qubits                           21
runner_id                            
pennylane-lightning.qubit  374.506058
qibo-qibojit               354.027429
qiskit-aer_simulator       117.215509
```
