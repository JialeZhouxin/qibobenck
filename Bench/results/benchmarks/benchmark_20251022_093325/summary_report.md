...
| 电路名称 | 量子比特数 | 电路深度 | 门总数 |
|---------|-----------|---------|--------|
| qft_20_qubits | 20 | 40.0 | 220.0 |

### 电路摘要示例

```
Circuit depth = 40
Total number of gates = 220
Number of qubits = 20
Most common gates:
cu1: 190
h: 20
...
### 最快执行
- 模拟器: qibo-qibojit
- 电路: qft_20_qubits (20 qubits)
- 平均时间: 0.2498 ± 0.0339 秒
...
n_qubits                         20
runner_id                          
pennylane-lightning.qubit  0.446649
qibo-qibojit               0.249750
```
